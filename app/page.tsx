...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      {/* 标题栏 */}
      <header className="bg-white/70 backdrop-blur-md shadow-md border-b border-white/20">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-3 space-y-5">
            {/* 币种选择器 */}
            <div className="bg-white/70 backdrop-blur-md rounded-xl shadow-md border border-white/20 p-5">
          ...
          <div className="col-span-9 space-y-6">
                    {/* 价格图表 */}
                    <div className="bg-white/70 backdrop-blur-md rounded-xl shadow-md border border-white/20 p-6 hover:shadow-lg transition-shadow">
                      <PriceChart 
                        data={coinData.price} 
