...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      {/* 标题栏 */}
      <header className="bg-white/80 backdrop-blur-sm shadow-lg border-b border-white/30">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-3 space-y-5">
            {/* 币种选择器 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/30 p-5">
          ...
          <div className="col-span-9 space-y-6">
                    {/* 价格图表 */}
                    <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/30 p-6 hover:shadow-xl transition-shadow">
                      <PriceChart 
                        data={coinData.price} 
